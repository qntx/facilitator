//! Command-line interface definitions for the x402 facilitator.
//!
//! This module defines the CLI structure using [`clap`] derive API with
//! two subcommands:
//!
//! - [`Commands::Init`] - Generate a default TOML configuration file
//! - [`Commands::Serve`] - Start the facilitator HTTP server
//!
//! # Usage
//!
//! ```sh
...
//! facilitator init
//! facilitator init --output my-config.toml
